...
<body style="width:700px; height:100% ;margin-left:420px; margin-top:80px">
  ...
  <div style="width:500px; height:100%">
   ...
   <div align="center"><h1>Đăng Ký Tài Khoản</h1></div>
   <br>
   	<div id="username_div">
    ...
    <div id="number_div">
   	   ...
   	   <input type="text" name="number" class="textInput">
    ...
    <div>
   	   ...
   	   <label class="sex">Nam</label><input type="radio" name="sex" value ="Nam" checked/>&emsp;<label class="sex">Nữ</label><input type="radio" name="sex" value="Nu"/>
   	</div>
    <br>
    <div><hr></div>
   	<div>
...
function Validate() {
  ...
  // validate username
  if(patt.test(username.value)==false){
    username.style.border = "1px solid red";
    document.getElementById('username_div').style.color = "red";
